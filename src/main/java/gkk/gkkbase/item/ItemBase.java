...
public class ItemBase extends Item implements IHasModel {
    ...
    public ItemBase(String registryName, String itemName, boolean subType, String modId, String... itemNameSuffix) {
        MODID = modId;
    ...
    public void registerModels() {
        if (this.getHasSubtypes()) {
            ArrayList<String> subtypeList = this.getSubtypeList();
